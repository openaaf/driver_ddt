...
INT smartcard_voltage_config(SCI_CONTROL_BLOCK *sci, UINT vcc)
{
	...
	if (sci->id == 0)
	{
...
#if !defined(SPARK) && !defined(HL101) && !defined(HS8200) && !defined(ADB_BOX) && !defined(VITAMIN_HD5000)  // no votage control
		...
		else
		{
			...
			sci->sci_atr_class = SCI_CLASS_A;
#if !defined(SUPPORT_NO_VOLTAGE)
#if !defined(SPARK) && !defined(HL101) && !defined(HS8200) && !defined(ADB_BOX) // no votage control
			set_reg_writeonly(sci, BASE_ADDRESS_PIO4, PIO_SET_P4OUT, 0x40);
#endif
#endif
...
static int SCI_SetClockSource(SCI_CONTROL_BLOCK *sci)
{
 ...
 || defined(VITAMIN_HD5000)
	...
	iounmap((void *)reg_address);
#endif
#if defined(CONFIG_CPU_SUBTYPE_STX7105) || defined(HS8200)
